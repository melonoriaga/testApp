                ...
                <View style={styles.rowSayHi}>
                    <View style={styles.rowFollowAndTevi}>
                        <TouchableOpacity
                            ...
                            onPress={() => alert('te sigo')}
                        >
                            <Text style={styles.textButtonFollow}>Seguir</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
...
const height_buttons_tevi = height * 0.06
const width_buttons_tevi = width * 0.4
const height_image_button_tevi = height * 0.04
const width_image_button_tevi = height * 0.07
